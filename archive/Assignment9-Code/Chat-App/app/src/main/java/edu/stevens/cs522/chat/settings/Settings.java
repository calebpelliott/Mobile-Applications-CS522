...
public class Settings {
    ...
    /*
     * Are we implementing synchronization of messages with the server, or just posting?
     */
    public static final boolean SYNC = true;

    /*
     * Are we operating in standalone mode i.e. just showing UI?
     */
    ...
    private static final String SERVER_URI_KEY = "server-uri";


    public static Uri getServerUri(Context context) {
        SharedPreferences prefs = context.getSharedPreferences(SETTINGS, Context.MODE_PRIVATE);
        return Uri.parse(prefs.getString(SERVER_URI_KEY, null));
    }
